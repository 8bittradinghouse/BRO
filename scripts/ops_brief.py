...
def build_brief(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    brief = {
        ...
        "taker_submits": _safe_float(fin.get("taker_submits")),
        "taker_fills": _safe_float(fin.get("taker_fills")),
        "taker_fill_rate": _safe_float(fin.get("taker_fill_rate")),
        "taker_midpoint_win_rate_proxy": _safe_float(fin.get("taker_midpoint_win_rate_proxy")),
        ...
        print(
            " | ".join(
                [
                    ...
                    f"taker_fill={brief['taker_fill_rate']:.2%}",
                    f"taker_midpoint_win_proxy={brief['taker_midpoint_win_rate_proxy']:.2%}",
