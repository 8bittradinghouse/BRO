...
CRITICAL_PATHS: Tuple[str, ...] = (
    ...
    "taker.enabled",
    "taker.min_edge",
    "taker.extreme_edge_mult",
    "taker.order_size",
    "taker.target_usd",
    "taker.max_orders_per_cycle",
    "taker.per_token_cooldown_sec",
)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Dotted path to compare; can be repeated. Defaults to critical runtime/taker paths.",
    )
